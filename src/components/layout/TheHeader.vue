                ...
                <div class="container-fluid">
                    <router-link class="navbar-brand" to="/">
                        ...
                        <div v-else>
                            ...
                            <img src="@/assets/images/CutoutPartner-Logo-PNG4.png" alt="" height="24" class="logo" v-else>
                        </div>
                    </router-link>
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <ul class="dropdown-menu service-dropdown" aria-labelledby="servicesDropdown">
                                    <div class="dropdown-container">
                                        <div class="dropdown-items">
                                            <li class="title"><b>E-Commerce Editing</b></li>
                                            <li><router-link to="/single-service" class="nav-link" aria-current="page">Ecommmerce photo editing services</router-link></li>
                                            <li><router-link to="/single-service" class="nav-link" aria-current="page">Ecommmerce photo editing services</router-link></li>
                                            <li><router-link to="/single-service" class="nav-link" aria-current="page">Ecommmerce photo editing services</router-link></li>
                                            <li><router-link to="/single-service" class="nav-link" aria-current="page">Ecommmerce photo editing services</router-link></li>
                                            <li><router-link to="/single-service" class="nav-link" aria-current="page">Ecommmerce photo editing services</router-link></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                                    <div class="dropdown-container">
                                        <div class="dropdown-items">
                                            <li><router-link to="/quotation" class="dropdown-item" aria-current="page">Get Quotation</router-link></li>
                                            <li><router-link to="/free-trial" class="dropdown-item" aria-current="page">Free Trial</router-link></li>
                                            <li><router-link to="/upload" class="dropdown-item" aria-current="page">Upload</router-link></li>
                                            <li><router-link to="/faq" class="dropdown-item" aria-current="page">Faq</router-link></li>
                                            <li><router-link to="/testimonial" class="dropdown-item" aria-current="page">Testimonail</router-link></li>
                                            <li><router-link to="/order" class="dropdown-item" aria-current="page">Order</router-link></li>
                                        </div>
                                    </div>
                                </ul>
                            </li>
...
export default {
    ...
    methods: {
        handleScroll() {
            ...
            if (window.scrollY > 150) { // Adjust 50 to the desired scroll distance
